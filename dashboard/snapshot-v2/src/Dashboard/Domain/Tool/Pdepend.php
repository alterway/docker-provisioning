...
class Pdepend implements ToolDashboardBuilderInterface, ToolDashboardSummaryInterface
{
    ...
    public function __construct()
    {
        ...
        if (!is_file($folder . '/pdepend-summary.xml')) {
            return;
        }
        ...
        $this->parseXmlData(simplexml_load_string(trim(file_get_contents($folder . '/pdepend-summary.xml'))));
    }
    ...
    protected function manageClassLevel(array &$packageLevel, SimpleXMLElement $package): Pdepend
    {
        ...
        // Special case for nomber of traits in package as it is not counted in the attributes of the XML pdepend.
