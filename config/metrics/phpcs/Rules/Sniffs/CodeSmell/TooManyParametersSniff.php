 ...
 * @subpackage Sniffs\CodeSmell
 */
class TooManyParametersSniff implements PHP_CodeSniffer_Sniff
{
    /**
     ...
     * @return void
     */
    private function checkParametersOnFunction(PHP_CodeSniffer_File $phpcsFile, int $stackPtr)
    {
     ...
     * @return void
     */
    private function checkParametersOnStaticMethod(PHP_CodeSniffer_File $phpcsFile, int $stackPtr)
    {
     ...
     * @return void
     */
    private function checkParametersOnDynamicMethod(PHP_CodeSniffer_File $phpcsFile, int $stackPtr)
    {
        $phpcsFile->recordMetric($stackPtr, 'Use of method', 'method');
     ...
     * @return void
     */
    private function checkParametersOnConstructor(PHP_CodeSniffer_File $phpcsFile, int $stackPtr)
    {
        $phpcsFile->recordMetric($stackPtr, 'Use of method', 'method');
     ...
     * @return int
     */
    private function getNumberOfArguments(PHP_CodeSniffer_File $phpcsFile, int $stackPtr): int
    {
        $tokens = $phpcsFile->getTokens();
